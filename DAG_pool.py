...
task2 = BashOperator(task_id="tsk2", bash_command="sleep 5", dag=dag, pool="mypool", prioryty_weight=5)
task3 = BashOperator(task_id="tsk3", bash_command="sleep 5", dag=dag, pool="mypool")
task4 = BashOperator(task_id="tsk4", bash_command="sleep 5", dag=dag, pool="mypool", prioryty_weight=10)
